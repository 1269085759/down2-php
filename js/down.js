...
function DownloaderMgr()
{
	...
	this.Config = {
        ...
        , "UrlList"     : "http://localhost:81/down2/v1.1-msg/db/f_list.php"
        , "UrlUpdate"   : "http://localhost:81/down2/v1.1-msg/db/f_update.php"
        //x86
	...
	this.add_ui = function (url, f_name)
	{
	    //存在相同项
	    ...
	    var ui_eles = { msg: uiMsg, name: uiName, size: uiSize, process: uiProcess, percent: uiPercent, btn: { cancel: btnCancel, stop: btnStop, down: btnDown, del: btnDel }, div: ui, split: sp };
	...
	{
	    var f = this.add_ui(fileSvr.fileUrl, fileSvr.nameLoc);
	...
	{
	    var obj = this.add_ui(url, f_name);
	...
	this.initUI = function (ui/*jquery obj*/)
	{
	    ...
	    this.btnSetup = ui.find('a[name="btnSetup"]').attr("href", this.Config.ExePath);
